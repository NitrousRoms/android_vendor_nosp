...
# Set all versions
NOSP_VERSION := $(PRODUCT_VERSION_MAJOR).$(PRODUCT_VERSION_MINOR).$(PRODUCT_VERSION_MAINTENANCE)-$(NOSP_BUILD_TYPE)$(NOSP_POSTFIX)
NOSP_MOD_VERSION := $(NOSP_BUILD)-$(PRODUCT_VERSION_MAJOR).$(PRODUCT_VERSION_MINOR).$(PRODUCT_VERSION_MAINTENANCE)-$(NOSP_BUILD_TYPE)$(NOSP_POSTFIX)
